...
export default function Calendar() {
  ...
  return (
    <div className="flex flex-col gap-4 lg:flex-row lg:gap-5" style={{ minHeight: 0 }}>
      {/* Sidebar */}
      <aside className="lg:w-52 shrink-0 flex flex-row flex-wrap lg:flex-col gap-4">
        {/* Filters */}
            ...
            return (
              <label key={type} className="flex items-center gap-2.5 cursor-pointer group">
                ...
                <span
                  ...
                  style={{ background: c.borderColor, opacity: on ? 1 : 0.3 }}
                />
      ...
      {/* Calendar */}
      <div className="glass flex-1 p-4 min-w-0">
        <FullCalendar
          ref={calRef}
