  ...
  return (
    <div className="glass p-6" style={{ borderColor: 'rgba(244,196,48,0.15)' }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
        ...
        <div style={{ gridColumn: '1 / -1', display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 14 }}>
          ...
          {form.recorrente && (
            <select value={form.recorrencia} onChange={set('recorrencia')} style={{ ...inputStyle, width: 'auto', colorScheme: 'dark' }}>
